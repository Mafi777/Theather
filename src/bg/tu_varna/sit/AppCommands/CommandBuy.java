...
public class CommandBuy {
    public void buy(String[] inputArray, Storage storage) {
        ...
        try {
            ...
            String ticketCode = storage.buyTicket(row, seat, date, name);
            if (ticketCode != null) {
                System.out.println("Successfully bought ticket with code: " + ticketCode);
            }
